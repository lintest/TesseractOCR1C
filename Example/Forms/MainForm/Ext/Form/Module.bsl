...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МакетКомпоненты = ОбработкаОбъект.ПолучитьМакет("TesseractOCR1С");
...
Процедура ПростойТест(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПолученРезультатЧтения", ЭтаФорма);
  	ТекстXML = ВнешняяКомпонента.НачатьВызовРаспознать(ОписаниеОповещения, ДанныеКартинки);
